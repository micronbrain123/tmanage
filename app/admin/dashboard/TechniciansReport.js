...
const TechniciansReport = () => {
  ...
  const techniciansData = []; // Empty for "No data found" state
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-xl font-semibold text-gray-900 mb-2">Technicians Report</h1>
          <p className="text-gray-600 text-sm">This report shows the quantity and amount of labors and services by technicians.</p>
        </div>
                  ...
                  {techniciansData.length > 0 ? (
                    techniciansData.map((item, index) => (
                      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                        <td className="px-6 py-4 text-sm text-gray-900">{item.technician}</td>
        ...
        {!showTable && !isPeriodDropdownOpen && !isDocumentTypeDropdownOpen && !isLocationDropdownOpen && (
          <div className="bg-white rounded-lg p-8 text-center text-gray-500">
            <p>Configure your filters above and click Apply to view the technicians report</p>
          </div>
        )}
      </div>
