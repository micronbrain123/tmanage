...
const SalesProfitReport = () => {
  ...
  const salesData = []; // Empty for "No data found" state
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-xl font-semibold text-gray-900 mb-2">Sales profit</h1>
                  ...
                  {salesData.length > 0 ? (
                    salesData.map((item, index) => (
                      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 text-right">{item.cost}</td>
                        <td className="px-6 py-4 text-sm text-gray-900 text-right">{item.wage}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
        ...
        {!showTable && !isPeriodDropdownOpen && !isLocationDropdownOpen && (
          <div className="bg-white rounded-lg p-8 text-center text-gray-500">
            <p>Select period and location filters, then click Apply to view the sales profit report</p>
          </div>
        )}
      </div>
